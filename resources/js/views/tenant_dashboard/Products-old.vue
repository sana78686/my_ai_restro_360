    ...
    <div class="Products-page">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                >
                    <i class="fas fa-trash-restore-alt me-1"></i> Deleted menu
                    items
                </button>
            </div>
            ...
            <div class="card-body">
                ...
                >
                    <i
                        ...
                        style="color: #bdbdbd"
                    ></i>
                    <div class="h5 mb-2">No menu items found</div>
                    <div>
                        No menu items match your search criteria.<br />Try
    ...
    setup() {
        ...
        const editProduct = (product) => {
            ...
            Object.assign(form.value, {
                ...
                newImages: [],
                imagePreviews: [],
                // keep full media objects (id,url,path) so template can show and delete them
