/**
 * Classic Theme Router
 * 
 * Routes for the classic tenant storefront theme.
 * Uses layouts and pages from the classic theme folder.
 */
...
const routes = [
    // Frontend routes (public storefront)
    {
        path: '/',
    ...
    // Dashboard routes (tenant admin - shared across themes)
    {
        path: '/dashboard',
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import('../../js/views/tenant_dashboard/Reservations.vue'),
            ...
            // ... more dashboard routes as needed
        ]
    }
]
